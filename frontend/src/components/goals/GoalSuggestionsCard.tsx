    ...
    return (
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-purple-200 p-6">
        <div className="animate-pulse">
          <div className="h-5 w-40 bg-purple-200 rounded mb-3"></div>
    ...
    <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-purple-200 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-purple-200/50">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">AI-Suggested Goals</h3>
            <p className="text-xs text-gray-500">Based on your spending patterns</p>
          </div>
        </div>
      </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-3">
                  <button
                    ...
                    className="flex-1 py-1.5 px-3 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 disabled:opacity-50 transition"
                  >
                    {adoptingSuggestion === suggestion.name ? 'Creating...' : 'Create Goal'}
                  </button>
                  <button
                    onClick={() => handleDismiss(suggestion.name)}
                    className="py-1.5 px-3 text-gray-500 text-sm hover:text-gray-700 hover:bg-gray-100 rounded-lg transition"
                  >
                    Dismiss
                  </button>
                </div>
